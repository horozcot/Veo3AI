...
function ResultsDisplayContinuation({ results }) {
  ...
  const copyJSONToClipboard = async (segment) => {
    try {
      const jsonString = JSON.stringify(segment, null, 2);
      ...
      textArea.value = JSON.stringify(segment, null, 2);
            ...
            <div className="segment-content">
              ...
              <details className="json-details">
                <summary className="json-summary">
                  <span className="json-summary-text">View Full JSON</span>
                  <button
                    className="copy-json-btn"
                    onClick={(e) => {
                      e.stopPropagation();
                      copyJSONToClipboard(segment);
                    }}
